...
let Roku = function (rokuIp) {
  ...
  */
  ...
  this.commands = [
    ...
    'up', 'back', 'replay', 'backspace',
    'search', 'enter'
  ];
};

// Register commands
Roku().commands.forEach(function (key) {
...
Roku.prototype.discover = function (timeout, cb) {
...
Roku.prototype.delay = function () { }; // todo
...
Roku.prototype.info = function (cb) {
